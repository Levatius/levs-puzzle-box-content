...
function RefreshTeams()
{
    ...
    teamsListRootNode.RemoveAndDeleteChildren()
    g_TeamPanels = []
    ...
    for ( var teamId of allTeamIDs )
    {
        ...
        if ( nNumPlayerSlots > 0 )
        {
            $.Msg("Adding team ", teamId, " with players ", nNumPlayerSlots)
...
(function()
{
    ...
    GameEvents.Subscribe("refresh_teams", RefreshTeams);
})();